...
namespace Alma.Flows.Tests.Core.Descriptions.Describers
{
    public class ActivityDescriberTest
    {
        ...
        public void Describe_CustomActivityTemplate_ShouldMapFields()
        {
            var template = new CustomActivityTemplate
            {
                ...
                Parameters =
                [
                    new CustomActivityParameterTemplate{ Id = "p1", Name = "A", DisplayName = "A D", Type = Alma.Flows.Core.Common.Enums.ParameterType.String },
                    new CustomActivityParameterTemplate{ Id = "p2", Name = "B", DisplayName = "B D", Type = Alma.Flows.Core.Common.Enums.ParameterType.Int }
                ],
                Ports =
                [
            ...
            var customType = typeof(Alma.Flows.Core.CustomActivities.CustomActivity);

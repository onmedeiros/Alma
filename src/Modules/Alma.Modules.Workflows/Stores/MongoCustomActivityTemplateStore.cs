...
namespace Alma.Modules.Workflows.Stores
{
    public class MongoCustomActivityTemplateStore : ICustomActivityTemplateStore
    {
        ...
        {
            _logger = logger;
            _collection = context.GetCollection<CustomActivityTemplate>("Workflows.CustomActivityTemplate");
            _scriptCollection = context.GetCollection<CustomActivityScript>("Workflows.CustomActivityScript");
        }

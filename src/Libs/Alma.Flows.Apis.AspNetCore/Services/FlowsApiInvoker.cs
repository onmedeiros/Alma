...
namespace Alma.Flows.Apis.AspNetCore.Services
{
    public class FlowsApiInvoker : IApiInvoker
    {
        private readonly ILogger<FlowsApiInvoker> _logger;
        ...
        public FlowsApiInvoker(ILogger<FlowsApiInvoker> logger, IHttpContextAccessor httpContextAccessor, IInstanceEndpointManager instanceEndpointManager, IFlowRunManager flowRunManager, IInstanceExecutionRunner instanceExecutionRunner)
        {
            _logger = logger;
